...
export const defaultThemeTokens: ThemeTokenConfig = {
  root: {
    ...
    "--color-platform-linux-titlebar": "#18181b",
    "--color-platform-linux-icon": "#fb923c",
    "--color-on-platform-titlebar": "#ffffff",
    "--color-window-hover-linux": "rgba(255, 255, 255, 0.1)",
    "--color-window-close-linux-hover": "#ea580c",
    "--color-window-close-hover": "#dc2626",
    "--color-on-window-close-hover": "#ffffff",
